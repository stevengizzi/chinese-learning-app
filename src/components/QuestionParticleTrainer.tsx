...
import { loadQuestionParticleItems, filterByParticles, shuffleItems } from '../lib/questionParticleParser';
import { QuestionParticleSetup } from './QuestionParticleSetup';
import { QuestionParticleExercise } from './QuestionParticleExercise';
import { QuestionParticleReport } from './QuestionParticleReport';

interface QuestionParticleTrainerProps {
  onBack: () => void;
}

export function QuestionParticleTrainer({ onBack }: QuestionParticleTrainerProps) {
  ...
  // Load items on mount
  useEffect(() => {
    loadQuestionParticleItems().then(items => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-gray-600 dark:text-gray-300 text-lg">Loading question particles corpus...</div>
        </div>
      </div>
    );
  }
