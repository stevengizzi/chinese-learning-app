...
import type { InterrogativeSession, InterrogativeItem, InterrogativeParticle } from '../types/interrogativeParticle';
import { ALL_INTERROGATIVE_PARTICLES, INTERROGATIVE_INFO } from '../types/interrogativeParticle';
...
interface QuestionParticleReportProps {
...
export function QuestionParticleReport({
  session,
  items,
  onBackToMenu,
  onNewSession,
}: QuestionParticleReportProps) {
  ...
  const statsByParticle: Record<InterrogativeParticle, ParticleStats> = {} as Record<InterrogativeParticle, ParticleStats>;

  for (const particle of ALL_INTERROGATIVE_PARTICLES) {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-3 gap-3">
              {ALL_INTERROGATIVE_PARTICLES.map(particle => {
            ...
            <div className="mb-8">
              ...
              <div className="max-h-64 overflow-y-auto space-y-2">
                {problemAttempts.map((attempt, index) => {
                  ...
                  const info = INTERROGATIVE_INFO[attempt.particle];
                      ...
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex-1">
                          <div className="text-sm text-gray-600 dark:text-gray-400">
                            {convertCharacters(item.statementChinese, characterSet)} → {item.statementEnglish}
                          </div>
